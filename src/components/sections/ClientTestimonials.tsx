    ...
    <section id="clients-say" className="py-8 sm:py-12 md:py-20" style={{ backgroundColor: '#F5F5F5' }}>
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="text-center mb-6 sm:mb-8 md:mb-16">
          ...
          <p className="text-gray-600 text-sm md:text-base max-w-5xl mx-auto leading-relaxed px-4 font-jost py-2 px-4 rounded-lg inline-block" style={{backgroundColor: '#ffe5e5'}}>
